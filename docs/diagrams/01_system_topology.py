...
top.connect("tauri_shell", "fastapi",     label=":8765/app")
...
top.connect("fastapi",     "ui_static",   label="/app mount")
top.connect("fastapi",     "rest_api",    label="routes")
top.connect("fastapi",     "ui_watcher",  label="daemon")
top.connect("fastapi",     "dev_version", label="endpoint")
top.connect("ui_watcher",  "svelte_src",  label="watches")
top.connect("ui_watcher",  "svelte_build",label="build")
top.connect("svelte_build","ui_static",   label="output")
top.connect("tauri_shell", "dev_version", label="poll 2s", style="dashed")
top.connect("pwa_android", "dev_version", label="poll 2s", style="dashed")
...
pipe.connect("watcher_th",    "vite_build",    label="changed")
pipe.connect("watcher_th",    "version_ep",    label="ver++")
pipe.connect("index_html",    "static_mount",  label="served")
pipe.connect("js_chunks",     "static_mount",  label="served")
pipe.connect("static_mount",  "tauri_wv",      label="GET /app")
pipe.connect("static_mount",  "browser",       label="GET /app")
pipe.connect("version_ep",    "tauri_wv",      label="poll", style="dashed")
pipe.connect("version_ep",    "browser",       label="poll", style="dashed")
